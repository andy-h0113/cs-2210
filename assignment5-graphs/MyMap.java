...
public class MyMap {
    ...
    //     try {
    //         MyMap mappy = new MyMap("map_-1");
    //     } catch (MapException e) {
    //         System.out.println("shit went wrongl");
    //     }
    // }
    ...
    boolean path (int startId, int endId, int privateNum, int construcNum) {
        try {
            ...
            //     // Checks if previous edge was a construction or private road
            //     Edge prevEdge = mapGraph.getEdge(startNode, prevNode);
            //     if ((prevEdge.getType()).equals(PRIVATE)) {
            //         maxPrivate++;
            //     } else if ((prevEdge.getType()).equals(CONSTRUCTION)) {
            //         maxConstruct++;
            //     }
            // } catch (EmptyStackException e) {
            //     // Empty with purpose
